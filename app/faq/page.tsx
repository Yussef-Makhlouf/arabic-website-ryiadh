...
export const metadata: Metadata = {
    ...
    description: 'إجابات شاملة على جميع الأسئلة الشائعة حول عزل الأسطح وأنواعه وأسعاره وضماناته. كل ما تريد معرفته عن عزل الفوم والعزل المائي وكشف التسربات.',
...
const faqCategories = [
    ...
    {
        title: 'أسئلة عن كشف التسربات',
        faqs: [
            {
                question: 'كيف يتم كشف تسربات المياه بدون تكسير؟',
                answer: 'نستخدم أجهزة إلكترونية متقدمة مثل أجهزة الاستماع الأرضي التي تكشف صوت تسرب المياه، وكاميرات التصوير الحراري التي تظهر فروق درجات الحرارة، وأجهزة ضغط النيتروجين لفحص المواسير.'
            },
            {
                question: 'كم يستغرق كشف التسربات؟',
                answer: 'عادة يستغرق الكشف من ساعة إلى 3 ساعات حسب حجم المبنى وتعقيد نظام السباكة. نقدم تقريراً مفصلاً بمواقع التسربات مع توصيات للإصلاح.'
            },
            {
                question: 'ما هي علامات وجود تسرب مياه؟',
                answer: 'أهم العلامات: بقع رطوبة على الجدران أو السقف، ارتفاع غير مبرر في فاتورة المياه، صوت مياه جارية عند إغلاق جميع الحنفيات، ظهور عفن أو رائحة رطوبة، تقشر الدهان أو الطلاء.'
            },
        ]
    },
    {
