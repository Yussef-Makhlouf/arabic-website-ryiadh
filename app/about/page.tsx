...
export const metadata: Metadata = {
    title: 'من نحن | شركة عزل اسطح الرياض - خبرة 15 عام في العزل',
    description: 'تعرف على شركة عزل اسطح الرياض، شركة سعودية متخصصة في عزل الأسطح والخزانات وكشف التسربات. خبرة 15 عاماً، فريق محترف، وضمان حقيقي.',
                    ...
                    <div className="container mx-auto px-4 md:px-6 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            <p className="text-xl md:text-2xl text-white/90 leading-relaxed mb-8">
                                شركة سعودية متخصصة في خدمات العزل الحراري والمائي وكشف التسربات منذ أكثر من 15 عاماً
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {[
                                ...
                                },
                                {
                                    ...
                                    desc: 'خدمة كشف تسربات المياه بأحدث الأجهزة الإلكترونية بدون تكسير. نستخدم أجهزة استماع متقدمة وكاميرات حرارية تحدد مكان التسرب بدقة متناهية. بعد الكشف نقدم تقريراً مفصلاً مع توصيات للإصلاح وعرض سعر.',
                                    features: ['بدون تكسير', 'دقة عالية', 'تقرير مفصل', 'خدمة 24 ساعة']
                                },
                                {
