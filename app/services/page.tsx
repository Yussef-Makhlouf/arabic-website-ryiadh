...
export const metadata = {
    title: 'خدمات عزل الأسطح في الرياض | عزل فوم - عزل مائي - كشف تسربات',
    description: 'جميع خدمات عزل الأسطح والمباني في الرياض والخرج. عزل فوم، عزل مائي، عازل أسمنتي، كشف تسربات المياه، وعزل خزانات المياه. ضمان شامل وأسعار منافسة.',
    keywords: ['خدمات عزل الأسطح', 'عزل فوم الرياض', 'عزل مائي الرياض', 'كشف تسربات الرياض'],
}
