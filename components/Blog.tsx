...
export default function Blog() {
  const blogPosts = [
    ...
    {
      id: 3,
      title: 'أهمية صيانة عزل الأسطح بشكل دوري',
      excerpt: 'تعرف على أهمية الصيانة الدورية لعزل سطح منزلك وكيف تساهم في إطالة عمر العزل وتوفير المال على المدى الطويل.',
      image: '/technician-applying-spray-foam-in-attic.webp',
      category: 'صيانة العزل',
      date: '2024-01-05',
      readTime: '6 دقائق'
    }
  ]
