...
export default function ServicesDetail() {
  const services = [
    ...
    {
      id: 'tiled-roof-insulation',
      icon: EyeIcon,
      title: 'عزل الأسطح المبلطة بالرياض',
      subtitle: 'عزل فوق البلاط بدون تكسير',
      description: 'عزل الأسطح المبلطة بأحدث تقنيات الفوم والمواد العازلة. نطبق العزل فوق البلاط مباشرة دون الحاجة للتكسير، مما يوفر الوقت والتكاليف مع ضمان حماية شاملة.',
      features: [
        'بدون تكسير للبلاط',
        'عزل حراري ومائي معاً',
        'حماية البلاط من التفكك',
        'سرعة التنفيذ',
        'ضمان 10 سنوات',
        'أسعار منافسة'
      ],
      process: [
        'فحص حالة البلاط',
        'تنظيف السطح جيداً',
        'تطبيق البرايمر اللاصق',
        'رش الفوم أو تطبيق العازل',
        'طبقة الحماية النهائية'
      ],
      image: '/tiled-roof-insulation.jpg'
    },
    {
      id: 'shincko-insulation',
      icon: WrenchScrewdriverIcon,
      title: 'عزل شينكو وهناجر بالرياض',
      subtitle: 'عزل متخصص للأسطح المعدنية والمستودعات',
      description: 'عزل فوم متخصص للهناجر والمستودعات والأسطح الشينكو المعدنية. أفضل حل لمنع الحرارة الشديدة وتسربات مياه الأمطار مع تحسين كفاءة التبريد.',
      features: [
