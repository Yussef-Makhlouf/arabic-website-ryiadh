...
export default function FAQ() {
  ...
  const faqs = [
    ...
    {
      question: 'هل يمكن عزل الأسطح المبلطة بدون تكسير؟',
      answer: 'نعم، نستخدم تقنيات حديثة لعزل الأسطح المبلطة فوق البلاط مباشرة بدون الحاجة للتكسير. نستخدم مواد شفافة أو عزل فوم متخصص يحمي البلاط ويمنع تسرب المياه والحرارة مع ضمان كامل.'
    },
    {
