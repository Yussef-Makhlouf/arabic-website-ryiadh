      ...
      <div className="container mx-auto px-6 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-4xl mx-auto leading-relaxed">
            شركة عزل اسطح بالرياض وعزل اسطح بالخرج متخصصة في تقديم أفضل عوازل للمباني. نقدم عازل مائي للأسطح، عازل أسمنتي، عزل فوم للأسطح، وعزل صوتي للجدران. نخدم جميع مناطق الرياض بما فيها شمال الرياض، معتمدون من الهيئة السعودية للمهندسين، بخبرة تزيد عن 15 عامًا وضمان شامل.
          </p>
        </div>
